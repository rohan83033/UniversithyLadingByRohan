...
export function LeadForm({ courses, onClose }: LeadFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const webhookUrl = process.env.NEXT_PUBLIC_PIPEDREAM_URL;
      
      if (!webhookUrl) {
        toast({
          title: 'Configuration Error',
          description: 'Webhook URL not configured. Please set NEXT_PUBLIC_PIPEDREAM_URL',
          variant: 'destructive'
        });
        setLoading(false);
        return;
